					...
					<div class="cart_products">
						<ul>
							...
							<li class=" cart_product d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-start">
                                                                ...
                                                                <!-- Imagem do Produto -->
                                                                <div class="cart_product_image"><img src="../arquivos/<%=livro.getFoto1()%>" width="100" hight="100" alt="" ></div>
                                                
								<!-- Nome do Produto -->
								<div class="cart_product_name"><a href="product.html"><%=livro.getNome()%></a></div>
								<div class="cart_product_info ml-auto">
									<div class="cart_product_info_inner d-flex flex-row align-items-center justify-content-md-end justify-content-start">
										<!-- Preço -->
										<div class="cart_product_price">R$ <%=livro.getPreco()%></div>
										<!-- Quantidade -->
										...
										<div class="cart_product_total">R$ <%=livro.getPreco()%></div>
										<!-- Botão Lixo Carrinho -->
					...
					<div class="cart_total">
						...
						<ul>
							...
							<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<div class="cart_total_price ml-auto">R$</div>
							</li>
						</ul>
						<button class="cart_total_button">Seguir para o checkout</button>
					</div>
				</div>
			</div>
		</div>
